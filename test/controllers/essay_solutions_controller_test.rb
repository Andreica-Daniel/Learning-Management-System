...
class EssaySolutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create essay_solution" do
    assert_difference('EssaySolution.count') do
      post essay_solutions_url, params: { essay_solution: { attachment: @essay_solution.attachment, essay_id: @essay_solution.essay_id, solution: @essay_solution.solution, student_id: @essay_solution.student_id } }
    end
  ...
  test "should update essay_solution" do
    patch essay_solution_url(@essay_solution), params: { essay_solution: { attachment: @essay_solution.attachment, essay_id: @essay_solution.essay_id, solution: @essay_solution.solution, student_id: @essay_solution.student_id } }
