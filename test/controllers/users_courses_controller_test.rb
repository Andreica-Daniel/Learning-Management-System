...
class UsersCoursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create users_course" do
    assert_difference('UsersCourse.count') do
      post users_courses_url, params: { users_course: { course_id: @users_course.course_id, user_id: @users_course.user_id } }
    end
  ...
  test "should update users_course" do
    patch users_course_url(@users_course), params: { users_course: { course_id: @users_course.course_id, user_id: @users_course.user_id } }
