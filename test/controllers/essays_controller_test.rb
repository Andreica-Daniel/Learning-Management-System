...
class EssaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create essay" do
    assert_difference('Essay.count') do
      post essays_url, params: { essay: { description: @essay.description, name: @essay.name } }
    end
  ...
  test "should update essay" do
    patch essay_url(@essay), params: { essay: { description: @essay.description, name: @essay.name } }
